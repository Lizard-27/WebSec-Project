...
<head>
  ...
  <style>
    ...
    .header-wrapper {
      width: 90%; max-width: 1500px; margin: 0 auto; position: relative; z-index: 10;
    }
    .custom-header {
      background: rgba(24,24,27,0.72);
      height: 56px; border-radius: 1.5rem;
      display: flex; align-items: center; justify-content: center;
      padding: 0 1.5rem; box-shadow: 0 2px 16px 0 #b11236;
      margin-top: 1.5rem; backdrop-filter: blur(8px) saturate(120%);
      border: 1px solid #b11236; transition: background 0.3s;
      position: relative;
    }
    .custom-header .left,
    .custom-header .right {
    ...
    .custom-header .center {
      display: flex; align-items: center; justify-content: center;
      height: 56px; position: relative; margin: 0 auto; z-index: 1;
    }
    .custom-header .center img {
      height: 38px; width: auto; display: block; margin: 0 auto;
      filter: drop-shadow(0 2px 8px #b11236); user-select: none;
    }
    .custom-header a {
      color: #f4f4f5; text-decoration: none; font-size: 1.08rem;
      font-weight: 500; padding: 0.2rem 0.7rem; border-radius: 1.2rem;
      transition: background 0.18s, color 0.18s; opacity: 0.92;
    }
    .custom-header a:hover {
      background: rgba(34,193,195,0.13); color: #dc143c;
    }
    .custom-header i { font-size: 1.32rem; vertical-align: middle; }
    .custom-header .badge {
      font-size: 0.85rem; padding: 0.2em 0.5em; border-radius: 1em;
      background: #fdba2d !important; color: #18181b !important;
      box-shadow: 0 2px 8px 0 rgba(34,193,195,0.10);
    }

    @media (max-width: 900px) {
      .custom-header {
        flex-direction: column; height: auto; padding: 1.2rem 1rem; gap: 0.7rem;
      }
      .custom-header .center {
        position: static; transform: none; margin: 0.5rem 0; justify-content: center;
      }
    }
    ...
    <div class="custom-header">
      ...
      <div class="right">
        @auth
          ...
          {{-- 👥 Show Users (permission: show_users) --}}
          @can('show_users')
